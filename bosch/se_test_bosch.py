...
# 🔴 MUST COME FIRST
# ===== SE REGISTRATION (REQUIRED) =====
import ultralytics.nn.tasks as tasks
from custom_modules import SE
...
model = YOLO('yolo26m-modified.yaml')  # start from pretrained COCO weights
...
model.train(
    data=yaml_path,
    epochs=400,             # increase if you have GPU time
    imgsz=640,             # image size (can change to 416 or 1280)
    batch=16,
    name='yolov26m_tiling_se_bosch',
    project='/home/vietpham/projects/yolo11m_for_label1/new',  # where to save results
