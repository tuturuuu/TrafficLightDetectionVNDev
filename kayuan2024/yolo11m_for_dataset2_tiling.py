...
yaml_path = os.path.join(dataset_path, "data-tiled.yaml")
...
model = YOLO("runs/detect/new/yolo26_traffic_light_dataset2_tiling/weights/best.pt") # start from pretrained COCO weights
...
model.train(
    ...
    batch=16,
    name='yolo26_traffic_light_dataset2_tiling',
    project='./new',  # where to save results
    device=[0,1],# use GPU if available
    verbose=True,
    patience=100,  # early stopping patience (optional)
)
